      ...
      <div className="product-art" style={{ background: `linear-gradient(135deg, ${colors[0]}, ${colors[1]})` }}>
        ...
        {isWebsite ? (
          <div className="mock-browser website-preview">
            <div className="browser-top"><div className="browser-dots"><i/><i/><i/></div><span>{product.name.toLowerCase().replaceAll(' ', '')}.demo</span></div>
      ...
      <div className="product-card-body">
        ...
        <div className="product-footer">
          ...
          <div className="card-actions">
            <Link className="small-button" to={product.demo}><ExternalLink size={14} /> Demo</Link>
